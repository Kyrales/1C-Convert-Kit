...
- `edt-validate.cmd` - валидация EDT проекта с помощью 1cedtcli/ring
...
- Использует 1cedtcli или ring для валидации
...
2. **Автоматический поиск инструментов** - EdtToolWrapper находит 1cedtcli/ring
