...
- `ScriptName` - тип конвертации (`dp2epf` или `dp2erf`)

`dp2xml` и `dp2edt` зарегистрированы в `ConverterRegistry`, но отдельные Python-маршруты для них пока не реализованы.
