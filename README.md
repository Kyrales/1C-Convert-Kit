...
[Возможности](#-возможности) • [Интерфейс](#-интерфейс) • [Установка](#-установка) • [Быстрый старт](#-быстрый-старт) • [Архитектура](#-архитектура)
...
## Зачем?
  ...
  - Для быстрой настройки конвертации из одного формата в другой. Например: Требуется перегнать cf релиза вендора в EDT-проект для использования дальше в обновлении.
  - Настройки конвертацию и взять из неё из лога работы постоянные скрипты для своих целей: настройки CI/CD, локальных запусков и др.
...
- ➕ Управление проектами в GUI интерфейсе: добавление, изменение, копирование, удаление
