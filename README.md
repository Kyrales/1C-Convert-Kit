...
Для `conf2ib`, `dt2ib` и `ext2ib` можно указать `V8_IB_UPDATE=1`, чтобы
после загрузки обновить конфигурацию базы данных. По умолчанию
`V8_IB_UPDATE=0`, поэтому обновление не выполняется.
